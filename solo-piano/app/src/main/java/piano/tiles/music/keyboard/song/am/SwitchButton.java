...
public class SwitchButton extends CheckBox {
    ...
    private void initView(Context context) {
        ...
        // get Bitmap
        mBottom = BitmapFactory.decodeResource(resources, R.drawable.piano_switch_roll_bottom);
        mBtnPressed = BitmapFactory.decodeResource(resources, R.drawable.piano_switch_roll_button);
        mBtnNormal = BitmapFactory.decodeResource(resources, R.drawable.piano_switch_roll_button);
        mFrame = BitmapFactory.decodeResource(resources, R.drawable.btn_frame);
        mMask = BitmapFactory.decodeResource(resources, R.drawable.btn_mask);
    ...
    private void setCheckedDelayed(final boolean checked) {
        this.postDelayed(new Runnable() {
            ...
            @Override
            public void run() {
                L.i("piano", "........setCheckedDelayed.........."+ checked);
                setChecked(checked);
            }
        }, 10);
    }
    ...
    public void setOnCheckedChangeListener(OnCheckedChangeListener listener) {
        ...
        L.i("piano", "........setOnCheckedChangeListener..........");
    }
