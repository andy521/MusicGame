...
//    private static String SKU_premium_test_month = "";
    ...
    public void purchase(Activity mActivity, String purchaseId, boolean isSubs, PurchaseFinishedListener purchaseFinishedListener) {
        this.purchaseFinishedListener = purchaseFinishedListener;
        currentPurchaseId = purchaseId;

//        MyLog.i("isgoogleplay available " + GoogleApiAvailability.getInstance().isGooglePlayServicesAvailable(mActivity));
...
//        }
        ...
        try {
            mHelper.launchPurchaseFlow(mActivity,
                    purchaseId,
                    isSubs ? IabHelper.ITEM_TYPE_SUBS : IabHelper.ITEM_TYPE_INAPP,
                    RC_REQUEST,
