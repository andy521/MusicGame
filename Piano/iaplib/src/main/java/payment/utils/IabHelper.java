...
public class IabHelper {
    ...
    public IabHelper(Context ctx, String base64PublicKey) {
        Log.i("PaymentManager", "IabHelper");
        mContext = ctx.getApplicationContext();
        Log.i("PaymentManager", "mContext after");
    ...
    public void startSetup(final OnIabSetupFinishedListener listener) {
            ...
            public void onServiceConnected(ComponentName name, IBinder service) {
                ...
                try {
                    ...
                    if (response != BILLING_RESPONSE_RESULT_OK) {
                        if (listener != null) listener.onIabSetupFinished(new IabResult(
                                response,
        ...
        Log.i("PaymentManager", "mContext=" + mContext);
        Log.i("PaymentManager", "mContext.getPackageManager()=" + mContext.getPackageManager());
        Log.i("PaymentManager",
     ...
     */
    public void launchPurchaseFlow(
            Activity act, String sku, String itemType, int requestCode,
            OnIabPurchaseFinishedListener listener, String extraData) {
        checkNotDisposed();
     ...
     * from a UI thread. For that, use the non-blocking version { #refreshInventoryAsync}.
     *
