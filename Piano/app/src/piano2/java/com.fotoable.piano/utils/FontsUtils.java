...
public class FontsUtils {
    public static Typeface typeAller, typeAmor, typeDutch;
    ...
    public static void initFonts(Context context){
        ...
        typeAmor = Typeface.createFromAsset(context.getAssets(), "fonts/AmorTextPro.ttf");
        typeDutch = Typeface.createFromAsset(context.getAssets(), "fonts/Dutch_title.ttf");
